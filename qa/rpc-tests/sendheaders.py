    ...
    def run_test(self):
        ...
        for i in range(4):
            ...
            if i == 0:
                ...
                block_time = last_time + 600
                new_block = create_block(tip, create_coinbase(absoluteHeight = height + 1), block_time)
                new_block.solve()
        ...
        block_time += 6000  # Advance far enough ahead
        for i in range(10):
            ...
            for j in range(2):
                blocks = []
                for b in range(i+1):
                    blocks.append(create_block(tip, create_coinbase(absoluteHeight = height), block_time))
                    blocks[-1].solve()
                    tip = blocks[-1].sha256
                    block_time += 600
                    height += 1
        ...
        for i in range(10):
            ...
            test_node.wait_for_getheaders(timeout=2)
            test_node.send_header_for_blocks(blocks)
