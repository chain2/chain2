...
BOOST_AUTO_TEST_CASE(caddrdb_read)
{
    ...
    CService addr1 = CService("250.7.1.1", 9393);
    CService addr2 = CService("250.7.2.2", 9999);
    CService addr3 = CService("250.7.3.3", 9999);

    // Add three addresses to new table.
    addrmanUncorrupted.Add(CAddress(addr1), CService("252.5.1.1", 9393));
    addrmanUncorrupted.Add(CAddress(addr2), CService("252.5.1.1", 9393));
    addrmanUncorrupted.Add(CAddress(addr3), CService("252.5.1.1", 9393));
